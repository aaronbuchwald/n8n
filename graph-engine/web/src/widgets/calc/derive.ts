...
// the reply. The cache makes the two consumers cheap: the calc editor's
// debounced per-keystroke preview and the canvas rendering of every dynamic
// node instance both key derivation by the exact literal value.
