...
def test_api_only_when_dist_missing(registry, tmp_path):
    # Point at a non-existent dir → nothing mounted at "/", so it 404s. No build
    # hint page is served; the API stays fully live.
